 ...
 * 
 * @author gergo0720
 * Class of the {@code King}. It has a {@link #moves} method, which sets up a 8x8 matrices with true value.
...
public class King {
	 ...
	 * Log information about the {@link #King}'s possible moves.
	 */
	 ...
	 * With this matrices, we create a {@link #possibleChess} matrices, which shows
	 * those squares on the board where from the king can be attacked.
	 */
	...
	/**
	 * Examine what piece are around the king and fill {@link #possibleMoves} accordingly.
	 ...
	 */
	public static void moves(int currPosRow, int currPosCol, JButton[][] chessSquare, boolean player){
		inits();
	...
	/**
	 * Examine the king's current position and set up the {@link #possibleChess} matrices with the possible places where king can be given chess from.
	 * @param currPosRow 
	 * 				is the row position of the piece before move
	 * @param currPosCol 
	 * 				is the column position of the piece before move
	 * @param chessSquare 
	 * 				is the matrices of the chess board
	 * @param player
	 * 				is which player is active, it is need to know to determine which king is active
	 */
	public static void chess(int currPosRow, int currPosCol, JButton[][] chessSquare, boolean player){
		inits();
		for(int i = 0; i < 1; i++) {
			for(int j = 0; j < 8; j++) {
